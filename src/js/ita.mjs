// * ita.mjs *
// This module make a class to populate SPID button with a remote json or the `ita-default` var content
//
// ## ita_default ##
// This object contain the defaults value to make a new Ita instance. 
// ### keys list ###
